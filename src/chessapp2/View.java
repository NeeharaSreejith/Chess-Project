...
public class View extends JFrame implements Observer{
    ...
    private JLabel regTitle = new JLabel("SIGN UP");
...
//        this.add(this.registrationPanel);
    ...
    public void choosePiece()
    {
        ...
        nextButton.setBounds(600,800,80,100);
        selectPiecePanel.add(nextButton);
...
//         if (data.loginFlag) { // If the game has not started, then start the game.
//            this.choosePiece(); // Change the interface of the frame with the options of pieces to choose from
//            this.started = true;
//            
//         } 
       if(data.nextFlag) { // move to the panel of chessboard
            ViewBoardPanel chessBoardPanel = new ViewBoardPanel();
            this.chessBoard(chessBoardPanel.boardPanel); // Check user's answer. 
         }
